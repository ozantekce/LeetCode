...
public class Solution {
    ...
    public int romanToInt(String s) {
        int array [];
        array = new int[22];    //  CHAR         CHAR_VAL             INDEX           INT_VAL
        array[6] = 1;           //  I               73      -67         6               1
        array[19] = 5;          //  V               86      -67         19              5
        array[21] = 10;         //  X               88      -67         21              10
        array[9] = 50;          //  L               76      -67         9               50
        array[0] = 100;         //  C               67      -67         0               100
        array[1] = 500;         //  D               68      -67         1               500
        array[10] = 1000;       //  M               77      -67         10              1000

        int sum = 0;
        int currentVal;
        int nextVal;
        for (int i = 0; i < s.length(); i++) {
            currentVal = array[(s.charAt(i)-67)];
            nextVal =-1;
            if(i!=s.length()-1){
                nextVal = array[(s.charAt(i+1)-67)];
            }
